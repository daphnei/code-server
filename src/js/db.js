...
(function() {
  var Q, connection, createQuestion, createQuestionOrUpdateScore, doesQuestionExist, getNextQuestionId, imagesearch, mysql, updateQuestionScore;
  ...
  exports.getAllFoods = function() {
    return exports.connectAndQuery('SELECT * FROM all_foods');
  };

  exports.addImageFor = function(food) {
    return imagesearch.findImage(food.Name).then(function(url) {
      return exports.connectAndQuery('INSERT INTO food_images (id, url) VALUES (?, ?)', [food.id, url]);
    });
  };
