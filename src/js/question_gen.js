...
(function() {
  var Q, a_per_b_question, comparision_question, db, fields, imagesearch, index, insertQuestion, make_food, units, _;
  ...
  make_food = function(name, genre, value, measure, unit, image) {
    return {
      name: name,
      genre: genre,
      value: value,
    ...
    if (queryString !== null) {
      db.connectAndQuery(queryString).then(function(data) {
        ...
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          ...
          addQuestionPromises.push(Q.all(imageNamePromises).then(function(_arg) {
            var element, image1, image2;
            image1 = _arg[0], image2 = _arg[1];
            element = {
              question_type: type,
